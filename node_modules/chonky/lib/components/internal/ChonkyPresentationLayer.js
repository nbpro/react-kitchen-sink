...
exports.ChonkyPresentationLayer = function (props) {
    ...
    var clearSelectionOnOutsideClick = recoil_1.useRecoilValue(options_recoil_1.clearSelectionOnOutsideClickState);
    // Deal with clicks outside of Chonky
    var onOutsideClick = react_1.useCallback(function (event, targetIsAButton) {
        ...
        if (!clearSelectionOnOutsideClick || targetIsAButton)
            return;
        selectionModifiers.clearSelection();
    }, [selectionModifiers, clearSelectionOnOutsideClick]);
    var chonkyRootRef = hooks_helpers_1.useClickListener({ onOutsideClick: onOutsideClick });
