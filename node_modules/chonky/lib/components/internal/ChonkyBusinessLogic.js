...
exports.ChonkyBusinessLogic = react_1.default.memo(react_1.default.forwardRef(function (props, ref) {
    var files = props.files, defaultFileViewActionId = props.defaultFileViewActionId;
    ...
    var clearSelectionOnOutsideClick = props.clearSelectionOnOutsideClick !== false;
    //
    // ==== File array sorting
    ...
    file_actions_1.useFileActions(fileActions, onFileAction, defaultFileViewActionId);
    //
    ...
    var setRecoilClearSelectionOnOutsideClick = recoil_1.useSetRecoilState(options_recoil_1.clearSelectionOnOutsideClickState);
    react_1.useEffect(function () {
